document.addEventListener('DOMContentLoaded', () => {
   ...
   function checkBoard() {
       ...
       //FYI: found this piece of code on StackOverflow 
       const winningArrays = [
       ...
       // now take the 4 value in each winningArray and plug them into the squares values
       for(let y = 0; y < winningArrays.length; y++) {
         ...
         if(square1.classList.constains('player-one') &&
         ...
         //now check to see if they all have the classname player two
          ...
          // if they do, player-two is passed as the winner as well as the chip position
